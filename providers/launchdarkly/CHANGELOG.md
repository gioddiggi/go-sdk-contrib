...
## [0.1.6](https://github.com/gdegiorgio/go-sdk-contrib/compare/providers/launchdarkly-v0.1.5...providers/launchdarkly/v0.1.6) (2025-09-23)
...
* **deps:** update golang.org/x/exp digest to 613f0c0 ([#185](https://github.com/gdegiorgio/go-sdk-contrib/issues/185)) ([529036e](https://github.com/gdegiorgio/go-sdk-contrib/commit/529036e7168726873844c6e0338459f89e00dc08))
* **deps:** update golang.org/x/exp digest to 7918f67 ([#308](https://github.com/gdegiorgio/go-sdk-contrib/issues/308)) ([658ac6d](https://github.com/gdegiorgio/go-sdk-contrib/commit/658ac6dee60ae9b455ead73e63b70b1cfed0444f))
...
* **deps:** update golang.org/x/exp digest to d63ba01 ([#280](https://github.com/gdegiorgio/go-sdk-contrib/issues/280)) ([6f7097f](https://github.com/gdegiorgio/go-sdk-contrib/commit/6f7097f898029ceafec486d58f99f682423c7b7c))
* **deps:** update golang.org/x/exp digest to fe59bbe ([#497](https://github.com/gdegiorgio/go-sdk-contrib/issues/497)) ([19dafe9](https://github.com/gdegiorgio/go-sdk-contrib/commit/19dafe937a0c367a4c2b419b45be27d17d90bce2))
* **deps:** update module github.com/launchdarkly/go-sdk-common/v3 to v3.1.0 ([#355](https://github.com/gdegiorgio/go-sdk-contrib/issues/355)) ([c1de190](https://github.com/gdegiorgio/go-sdk-contrib/commit/c1de190948cb33d9e5fd04a3ffad2e770844d16a))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v6 to v6.1.0 ([#186](https://github.com/gdegiorgio/go-sdk-contrib/issues/186)) ([9f825cb](https://github.com/gdegiorgio/go-sdk-contrib/commit/9f825cb7e612f7895322934259b02f2984e661e8))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v6 to v6.1.1 ([#349](https://github.com/gdegiorgio/go-sdk-contrib/issues/349)) ([d14883e](https://github.com/gdegiorgio/go-sdk-contrib/commit/d14883eb37c18a46852cd713e2538151f5d797ec))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v6 to v6.2.0 ([#492](https://github.com/gdegiorgio/go-sdk-contrib/issues/492)) ([eb97cb7](https://github.com/gdegiorgio/go-sdk-contrib/commit/eb97cb7a31145156d403ae7cf99843908f429040))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v6 to v7 ([#370](https://github.com/gdegiorgio/go-sdk-contrib/issues/370)) ([402ba16](https://github.com/gdegiorgio/go-sdk-contrib/commit/402ba1610fd0d1a734d166da17544495a2c7628f))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v7 to v7.11.0 ([#709](https://github.com/gdegiorgio/go-sdk-contrib/issues/709)) ([ee56e7d](https://github.com/gdegiorgio/go-sdk-contrib/commit/ee56e7d52eaef4901cc39083dd244fd476707899))
* **deps:** update module github.com/launchdarkly/go-server-sdk/v7 to v7.6.2 ([#565](https://github.com/gdegiorgio/go-sdk-contrib/issues/565)) ([6d92716](https://github.com/gdegiorgio/go-sdk-contrib/commit/6d927163c15143419e88c96f7931ebb5ad7b03c7))
...
* use narrow local LDClient interface, not *LDClient struct ([#532](https://github.com/gdegiorgio/go-sdk-contrib/issues/532)) ([7c65a54](https://github.com/gdegiorgio/go-sdk-contrib/commit/7c65a549a301a2be69380f4f0f14d9b6cdf35dda))


### ✨ New Features

* **deps:** Upgrade LaunchDarkly SDK version to v7 ([#525](https://github.com/gdegiorgio/go-sdk-contrib/issues/525)) ([95ab5d1](https://github.com/gdegiorgio/go-sdk-contrib/commit/95ab5d139aab4722873cf54df4d6c1e0948034bd))
* **launchdarkly-provider:** Add provider ([#178](https://github.com/gdegiorgio/go-sdk-contrib/issues/178)) ([487706e](https://github.com/gdegiorgio/go-sdk-contrib/commit/487706ec09a85a000edae25abb79b0928262413c))
